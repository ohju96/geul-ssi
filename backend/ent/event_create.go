...
func (ec *EventCreate) SetContents(s string) *EventCreate {
	ec.mutation.SetContents(s)
	return ec
}

// SetWriter sets the "writer" field.
func (ec *EventCreate) SetWriter(s string) *EventCreate {
	ec.mutation.SetWriter(s)
	return ec
}
...
func (ec *EventCreate) check() error {
	if _, ok := ec.mutation.Contents(); !ok {
		return &ValidationError{Name: "contents", err: errors.New(`ent: missing required field "Event.contents"`)}
	}
	if _, ok := ec.mutation.Writer(); !ok {
		return &ValidationError{Name: "writer", err: errors.New(`ent: missing required field "Event.writer"`)}
	}
	if _, ok := ec.mutation.CreatedAt(); !ok {
...
func (ec *EventCreate) createSpec() (*Event, *sqlgraph.CreateSpec) {
	...
	if value, ok := ec.mutation.Contents(); ok {
		_spec.SetField(event.FieldContents, field.TypeString, value)
		_node.Contents = value
	}
	if value, ok := ec.mutation.Writer(); ok {
		_spec.SetField(event.FieldWriter, field.TypeString, value)
		_node.Writer = value
	}
