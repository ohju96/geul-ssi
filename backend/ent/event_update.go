...
func (eu *EventUpdate) SetContents(s string) *EventUpdate {
	eu.mutation.SetContents(s)
	return eu
}

// SetWriter sets the "writer" field.
func (eu *EventUpdate) SetWriter(s string) *EventUpdate {
	eu.mutation.SetWriter(s)
	return eu
}
...
func (eu *EventUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := eu.mutation.Contents(); ok {
		_spec.SetField(event.FieldContents, field.TypeString, value)
	}
	if value, ok := eu.mutation.Writer(); ok {
...
// SetContents sets the "contents" field.
func (euo *EventUpdateOne) SetContents(s string) *EventUpdateOne {
	euo.mutation.SetContents(s)
	return euo
}

// SetWriter sets the "writer" field.
func (euo *EventUpdateOne) SetWriter(s string) *EventUpdateOne {
	euo.mutation.SetWriter(s)
	return euo
}
...
func (euo *EventUpdateOne) sqlSave(ctx context.Context) (_node *Event, err error) {
	...
	if value, ok := euo.mutation.Contents(); ok {
		_spec.SetField(event.FieldContents, field.TypeString, value)
	}
	if value, ok := euo.mutation.Writer(); ok {
		_spec.SetField(event.FieldWriter, field.TypeString, value)
	}
